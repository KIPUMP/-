...
def open_manage_view():
  ...
  btnemployee = Button(manage_root,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="EMPLOYEE", bg="powder blue", command=controller.employee_button_listener)
